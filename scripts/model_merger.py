...
from verl1.utils import hf_processor, hf_tokenizer
...
class MegatronModelMerger(BaseModelMerger):
    def __init__(self, config: ModelMergerConfig):
        from verl1.utils.megatron_utils import get_hf_config_and_tokenizer_checkpoint_path
    ...
    def merge_and_save(self):
        from verl1.utils.megatron_utils import get_model_checkpoint_path
