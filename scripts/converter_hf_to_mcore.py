...
from verl1.models.mcore import hf_to_mcore_config
from verl1.utils.megatron_utils import get_model
...
def convert_hf_to_mcore(hf_model_path, output_path, use_cpu_initialization=False, test=False, trust_remote_code=False):
    ...
    def megatron_model_provider(pre_process, post_process):
        from verl1.models.mcore import init_mcore_model
    ...
    if "Qwen2MoeForCausalLM" in hf_config.architectures:
        ...
        from verl1.models.mcore.loader import load_state_dict_to_megatron_gptmodel
